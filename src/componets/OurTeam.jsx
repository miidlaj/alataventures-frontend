                            ...
                            <div className="preview-card__item">
                              ...
                              <div className="preview-card__content">
                                ...
                                <div className="preview-card__text">
                                  ...
                                  Mohamed Sanoob is a Director at Alata Ventures
                                  Pvt Ltd. His career spans 9 years in the UAE
                                  and 3 years in India, and he has contributed
                                  to prestigious projects with industry leaders
                                  like Damac. As a highly skilled draughtsman,
                                  he ensures precision and innovation in every
                                  project. Mohamed's international experience
                                  and commitment to excellence drive Alata
                                  Ventures' success and vision for future growth
                                ...
                                <div className="preview-card__text">
                                  ...
                                  <ul className="list-group list-group-flush">
                                    <li className="list-group-item">
                                      ...
                                      <br />
                                      <b>Client:</b> Damac star properties LLC.
                                      <br />
                                      <b>Consultant:</b> Engineering Consortium
                                    ...
                                    <li className="list-group-item">
                                      <b>
                                        ...
                                        (230)Jadaf (4 Basement + 1 Ground floor
                                        + 12 Typical floors)
                                      </b>
                                      <br />
                                    ...
                                    <li className="list-group-item">
                                      <b>
                                        ...
                                        No.231-259, Al Nahda 1, Dubai. & G+6 CAR
                                        PARKING , Plot No. 231-350
                                      </b>
                                      <br />
                                      <b>Client:</b> AQIL AL ZAROONI
                                      <br />
                                      <b>Consultant:</b> INSPIRATION ENGINEERING
                                      CONSULTANCY
                                      <br />
                                      <b>Position:</b> Project Draughtsman
                                    </li>
