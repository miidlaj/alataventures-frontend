        ...
        <div role="alert" className="container mx-auto w-11/12 max-w-lg">
          <div className="relative py-8 px-5 bg-white shadow-md rounded border border-gray-400 h-full scroll-modal">
            ...
            <div className="flex justify-center items-center bg-white pb-3">
              <div className="w-full relative grid grid-cols-1 border border-gray-300 bg-gray-100 rounded-lg">
                <div className="relative order-first h-28 flex justify-between items-center border border-dashed border-gray-400 col-span-2 m-2 rounded-lg bg-no-repeat bg-center bg-origin-padding bg-cover">
